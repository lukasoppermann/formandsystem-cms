...
?>
<div class="o-fragment o-fragment--{{$item->get('type')}} o-grid__column o-grid__user-column--md-{{$item->metadetails('type','columns_medium',true)->get('data', 12)}}of{{config('user.grid-md')}} {{$custom_class or ''}}">
